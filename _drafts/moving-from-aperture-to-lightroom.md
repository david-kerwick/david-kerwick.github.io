...
So now that I'm impressed enough it's time to see what the whole libary looks like in LightRoom. My libary is reasonably sized, 80GB with around 17,000 photos. I have load of hard drive space though as I have an SSD for the main drive and a 1TB drive for the photo's so I'm not concerned about duplicating the photo's in the short term.