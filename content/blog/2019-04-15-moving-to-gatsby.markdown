---
layout: 'post'
title: 'Moving Blog to Gatsby'
date: '2019-04-15T15:12:42'
---
It's that time again, where I look at blogging something and decide I may as well change the system I'm using first.
A developer affliction I'm sure. Jekyll has worked really well and it's blog workflow is really good. But may as well try the new kid. Well by the time I tend to hear about these things they aren't that new, but for some reason [GatsbyJS](https://www.gatsbyjs.org/) kept showing up in my twitter feed with people saying how awesome it is, in particular the developer experience.
...
I don't regret the move at all, well not yet anyway. Jekyll was no slow couch but Gatsby is spooky fast ([they do a better job at explaining why it's interesting](https://www.gatsbyjs.org/blog/2017-09-13-why-is-gatsby-so-fast/)) and the whole thing feels more approachable as it's npm/javascript I never had much exposer to Ruby.
